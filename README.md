# genpark-enterprise-agent-permission-boundary-governor-skill
...
> **GenPark AI Agent Skill** -- Enterprise agent execution environment & permission boundary governor (Tines style)
